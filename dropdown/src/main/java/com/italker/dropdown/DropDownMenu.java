...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        @SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.dropDownMenu);
    ...
    public void setDropDownMenu(List<String> tabTexts, List<View> popupViews, ImageView contentView)
        ...
        for (int i = 0; i < popupViews.size(); i++) {
            ...
            view.setLayoutParams(new FrameLayout.LayoutParams(MATCH_PARENT
                    , WRAP_CONTENT));
